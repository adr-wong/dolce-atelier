        ...
        headers: [
          {
            ...
            value: [
              ...
              "font-src 'self' https://fonts.gstatic.com",
               `connect-src 'self' https://*.clerk.com https://*.clerk.dev https://*.clerk.accounts.dev https://clerk-telemetry.com https://*.clerk-telemetry.com https://api.stripe.com https://res.cloudinary.com ${mcpOrigin}`,
